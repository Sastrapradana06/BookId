...
export default function CardMembers({
  ...
  return (
    <>
      ...
      <div className="w-[160px] h-[250px] rounded-lg shadow-md  lg:w-[160px]  p-3 bg-gray-700 relative">
        <span
        ...
        <div className="w-full h-full  flex flex-col items-center justify-between">
          ...
          <div className="w-full h-max  flex gap-2 items-center justify-center mt-4">
            ...
            {user.role == "super admin" || user.role == "admin" ? (
              <button
                className="p-2 rounded-md bg-red-500 hover:bg-red-600 disabled:cursor-not-allowed disabled:bg-red-400"
